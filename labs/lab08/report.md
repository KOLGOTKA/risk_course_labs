...
1) Утечка и компрометация пользовательских и административных данных
...
2) Захват пользовательских и административных сессий
...
4) Усиление клиентских атак и эксплуатация уязвимостей браузера
